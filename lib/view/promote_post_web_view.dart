...
class PromotePostWebsiteView extends StatefulWidget {
  ...
  @override
  _PromotePostWebsiteViewState createState() => _PromotePostWebsiteViewState();
}

class _PromotePostWebsiteViewState extends State<PromotePostWebsiteView> {
