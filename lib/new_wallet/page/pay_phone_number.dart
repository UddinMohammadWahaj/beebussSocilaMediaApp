...
// class PayPhoneNumberScreen extends StatefulWidget {
//   const PayPhoneNumberScreen({Key key}) : super(key: key);

//   @override
//   State<PayPhoneNumberScreen> createState() => _PayPhoneNumberScreenState();
// }

// class _PayPhoneNumberScreenState extends State<PayPhoneNumberScreen> {
//   TextEditingController searchController = TextEditingController();
//   bool isSearch = false;

//   onSubmit(String text) async {
//     print("onSubmit Key $text");
//     if (text.isEmpty) {
//       setState(() {
...
//                       future: UserConnection()
//                           .payByNumber(searchController.text.toString()),
//                       builder: (context, snapshot) {
//                         if (snapshot.hasData) {
//                           return snapshot.data.user?.length != 0
//                               ? ListView.builder(
...
//                                                     '${Constant.PROFILE_URL}${snapshot.data.user[index].profileImage}',
//                                                   ),
//                                                 ),
//                                                 SizedBox(
//                                                   width: 25,
...
//                                                       ),
//                                                       Text(
//                                                         '${snapshot.data.user[index].mobile}',
//                                                         style: TextStyle(
//                                                             fontWeight:
//                                                                 FontWeight
//                                                                     .normal,
