...
class AndroidIntentHelpers {
  static void inviteFriend(BuildContext context) {
    if (const LocalPlatform().isAndroid) {
      ...
      //     'android.intent.extra.SUBJECT': 'Bebuzee Messenger: Android + iPhone + Windows Phone',
      //     'android.intent.extra.TEXT':
      //         'Hey,\n\nBebuzee Messenger is a fast, simple and secure app that I use to message and call the people I care about.\n\nGet it for free at https://bebuzee.com/download/',
      //   },
      // );
      // intent.launch();
    } else {
      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
          content: Text(
        AppLocalizations.of('Sorry, this only works in Android.'),
      )));
    }
  }
