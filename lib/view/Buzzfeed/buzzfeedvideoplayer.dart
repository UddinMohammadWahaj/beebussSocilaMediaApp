...
class BuzzerfeedVideoPlayer extends StatefulWidget {
  BuzzerfeedVideoPlayer({Key? key, this.title, this.url}) : super(key: key);
  final String? title;
  final String? url;

  @override
  _BuzzerfeedVideoPlayerState createState() => _BuzzerfeedVideoPlayerState();
}

class _BuzzerfeedVideoPlayerState extends State<BuzzerfeedVideoPlayer> {
