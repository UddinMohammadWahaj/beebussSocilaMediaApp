...
class PopularRealEstatePropertyInfoCard
    extends GetView<PopularRealEstateMarketController> {
  final double? padding;
  final int? index;
  final int? val;
  const PopularRealEstatePropertyInfoCard({
    Key? key,
    this.padding,
    this.index,
    this.val,
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          Text(
            AppLocalizations.of(
                "from ${controller.lstofpopularrealestatemodel[index!].currency} ${controller.lstofpopularrealestatemodel[index!].cost}"),
            style: TextStyle(
                fontSize: 22,
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          Text(
            AppLocalizations.of(
              controller.lstofpopularrealestatemodel[index!].listingType == "1"
