...
class PromotePost extends StatefulWidget {
  ...
  @override
  _PromotePostState createState() => _PromotePostState();
}
...
class _PromotePostState extends State<PromotePost> {
  ...
  Future<void> getBoostData() async {
    var url = Uri.parse(
        "https://www.bebuzee.com/app_devlope_all_boosted.php?action=boost_post_home&user_id=${widget.memberID}&post_type=${widget.feed!.postType}&country=${widget.country}&post_id=${widget.feed!.postId}");
    var newurl = Uri.parse(
        'https://www.bebuzee.com/api/campaign/sponserPost?user_id=${widget.memberID}&post_type=${widget.feed!.postType}&country=${widget.country}&post_id=${widget.feed!.postId}');
    var client = Dio();
...
// Future <List> getProperbuzErrorHandle()async{
//  var url="";
//  var client=Dio();
...
// }
  ...
  Future<void> getAudienceData() async {
    ...
    // var response =
    //     await ApiRepo.postWithToken("api/audience_data_seperate.php", {
    //   "action": "get_all_audience_user",
  ...
  Future<void> boostPost() async {
    var newurl =
        'https://www.bebuzee.com/api/save_boosted_data.php?user_id=${CurrentUser().currentUser.memberID}&post_id=${widget.feed!.postId}&ad_budget=${_value.toString()}';
    ...
    print("boost post ${widget.feed!.postId}");

    var exdtra = {
      "user_id": CurrentUser().currentUser.memberID,
      "post_id": widget.feed!.postId,
      ...
      "post_type": widget.feed!.postType,
    };
                      ...
                      Column(
                        ...
                        children: [
                          widget.feed!.postType == "Image" ||
                              ...
                              : Padding(
                                  padding: EdgeInsets.only(top: 2.0.h),
                                  child: widget.feed!.postVideoWidth != null
                                      ? AspectRatio(
                                          aspectRatio:
                                              widget.feed!.postVideoWidth /
                                  ...
                                  if (selectedButton ==
                                    ...
                                    setState(() {
                                      ...
                                      _buttonLinkController.text =
                                          "https://www.bebuzee.com/${widget.feed!.postShortcode}";
                                    });
                                  } else {
                                    setState(() {
