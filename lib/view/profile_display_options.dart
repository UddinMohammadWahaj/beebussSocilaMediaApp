...
//TODO :: inSheet 46
  Future<void> hideOptions(int category, int contact) async {
    // var url = Uri.parse(
    //     "https://www.bebuzee.com/new_files/all_apis/user_update_data.php?action=update_profile_contact_display&user_id=${CurrentUser().currentUser.memberID}&contact=$contact&category=$category");
