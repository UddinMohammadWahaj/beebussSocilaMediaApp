      ...
      return ListTile(
        ...
        title: Row(
          children: [
            ...
            widget.buzzerfeedMainController!
                        .listbuzzerfeeddata[widget.userindex!].varified !=
                    ""
                ? Container(
                    // height: 0.2.h,
                    // width: 0.2.w,
        ...
        child: Row(
          children: [
            TextButton(
                onPressed: () {},
                child: Text(
                  '${widget.buzzerfeedMainController!.listbuzzerfeeddata[widget.userindex!].totalReBuzzerfeed} ' +
            ...
            TextButton(
                onPressed: () {},
                child: Text(
                  '${widget.buzzerfeedMainController!.listbuzzerfeeddata[widget.userindex!].quotes!.length} ' +
            ...
            TextButton(
                onPressed: () {},
                child: Text(
                  '${widget.buzzerfeedMainController!.listbuzzerfeeddata[widget.userindex!].totalLikes} ' +
                ...
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => BuzzerfeedExpanded(
                          ...
                          userindex: 0,
                          username:
                              controller.commentList[index].memberName!)));
                },
                title: Text(
                    '${controller.commentList[index].memberName} . ${controller.commentList[index].timeStamp}'),
                subtitle: Column(
