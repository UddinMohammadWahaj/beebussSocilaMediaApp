...
class ViewSingleGroupFile extends StatefulWidget {
  ...
  @override
  _ViewSingleGroupFileState createState() => _ViewSingleGroupFileState();
}

class _ViewSingleGroupFileState extends State<ViewSingleGroupFile> {
      ...
      builder: (BuildContext deleteContext) {
        ...
        return DeleteMessagePopup(
          ...
          deleteForMe: () {
            ...
            customToastWhite(AppLocalizations.of("Message deleted"), 15.0,
                ToastGravity.CENTER);
          ...
          deleteForAll: () {
            ...
            Navigator.pop(deleteContext);
            GroupApiCalls()
                .deleteMessagesEveryone(messageID, "", widget.topic!);
          },
        );
      },
    );
                            ...
                            Column(
                              ...
                              children: [
                                Container(
                                  width: 100.0.w - 195,
                                  child: Text(
                                    _chatMessages[selectedIndex].you! == 0
                                        ? _chatMessages[selectedIndex].username!
                                        : "You",
                                    style: TextStyle(
...
class MultiVideoPlayer extends StatefulWidget {
  ...
  MultiVideoPlayer({Key? key, this.path, this.showProgressIndicator})
      : super(key: key);
        ...
        child: VisibilityDetector(
          ...
          child: FlickVideoPlayer(
            ...
            flickVideoWithControls: FlickVideoWithControls(
              ...
              controls: widget.showProgressIndicator!
                  ? Stack(
                      children: [
                        Positioned(
                          bottom: 20,
