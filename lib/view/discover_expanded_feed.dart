...
class _DiscoverExpandedFeedState extends State<DiscoverExpandedFeed> {
  ...
  Future<String> likeUnlikeComment(String commentID, int index) async {
    var url = Uri.parse(
  ...
  Future<String> likeUnlikeSubcomment(String subcommentID) async {
    var url = Uri.parse(
  ...
  Future<String> likeUnlikePost() async {
    print("expanded discover");
    var url = Uri.parse(
  ...
  Future<String?> reportCommentSpam(String commentID) async {
    var url = Uri.parse(
  ...
  Future<String?> reportCommentAbusive(String commentID) async {
    var url = Uri.parse(
  ...
  Future<String?>? deleteSubcomment(String subcommentID) async {
    var url = Uri.parse(
  ...
  Future<String?> reportSubcommentAbusive(String subcommentID) async {
    var url = Uri.parse(
  ...
  Future<void> postComment(String comment) async {
    ...
    // }
    var newurl = Uri.parse(
        'https://www.bebuzee.com/api/newsfeed/postCommentAdd?action=post_comment_main&user_id=${widget.memberID}&post_type=${feed.postType}=&post_id=${feed.postId}&comments=$comment');
                                                                ...
                                                                children: [
                                                                  ...
                                                                  Text(
                                                                    commentsList.comments[index].isSubCommentOpen ==
                                                                        ...
                                                                        ? AppLocalizations.of(
                                                                            "Hide Replies")
                                                                        : "View Replies (${commentsList.comments[index].subComment.toString()})",
                                                                    style: TextStyle(
                                                                        color: Colors
                                                                            .grey,
                                                                        fontSize:
