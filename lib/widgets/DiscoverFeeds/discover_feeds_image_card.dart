...
class DiscoverFeedsImageCard extends StatefulWidget {
  ...
  @override
  _DiscoverFeedsImageCardState createState() => _DiscoverFeedsImageCardState();
}

class _DiscoverFeedsImageCardState extends State<DiscoverFeedsImageCard> {
  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        widget.feed!.postMultiImage == 1 && widget.feed!.postType == "Image"
            ? GestureDetector(
                onDoubleTap: () {
                        ...
                        Container(
                          ...
                          child: ConstrainedBox(
                            ...
                            child: PageView.builder(
                              ...
                              itemCount:
                                  widget.feed!.postAllImage!.split("~~").length,
                      ...
                      showModalBottomSheet(
                          ...
                          builder: (BuildContext bc) {
                            return PostShare(
                              ...
                              shareUrl: () async {
                                Share.share(widget.feed!.postUrlToShare);
        ...
        Padding(
          ...
          child: Container(
            ...
            child: Text(
              widget.feed!.postType == "Video" ||
                      widget.feed!.postType == "svideo"
                  ? widget.feed!.postNumViews.toString()
