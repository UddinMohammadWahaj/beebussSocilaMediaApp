...
class _NotificationsSettingsScreenState
  ...
  late NotificationToneOptions defaultNotificationTone;
  ...
  late NotificationToneOptions defaultGroupNotificationTone;
  ...
  late RingtoneOptions defaultCallsRingtone;
    ...
    return Scaffold(
            ...
            itemBuilder: (BuildContext context) {
              return [
                PopupMenuItem(
                  ...
                  child: Text(
                    AppLocalizations.of('Reset notification settings'),
                  ),
                )
              ];
            },
      ...
      body: ListView(
        children: <Widget>[
          ...
          _buildFutureSettingItem(
              context,
              AppLocalizations.of("Vibrate"),
              vibrateOptionsList,
              _vibrate,
              _getVibrateText,
              false, (VibrateOptions value) {
          ...
          Divider(),
          SettingItemHeader(
            title: AppLocalizations.of("Groups"),
            padding: EdgeInsets.only(
                top: 16.0, left: 24.0, right: 24.0, bottom: 4.0),
          ),
          _buildFutureSettingItem(
          ...
          Divider(),
          SettingItemHeader(
            title: AppLocalizations.of("Calls"),
            padding: EdgeInsets.only(
                top: 16.0, left: 24.0, right: 24.0, bottom: 4.0),
          ),
          _buildFutureSettingItem(
              context,
              AppLocalizations.of("Ringtone"),
              ringtoneOptionsList,
              _callsRingtone,
              _getRingtoneText,
              true, (RingtoneOptions value) {
  ...
  _resetSettings() async {
    ...
    setState(() {
      ...
      _notificationTone = prefs
          .setInt(SharedPreferencesHelpers.notificationTone, 0)
          .then((bool success) {
        return null;
      });
      ...
      _groupNotificationTone = prefs
          .setInt(SharedPreferencesHelpers.groupNotificationTone, 0)
          .then((bool success) {
        return null;
      });
      _groupVibrate = prefs
      ...
      _callsRingtone = prefs
          .setInt(SharedPreferencesHelpers.callsRingtone, 0)
          .then((bool success) {
        return null;
      });
      _callsVibrate = prefs
