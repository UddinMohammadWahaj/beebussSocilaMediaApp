...
class AddPropertyMap extends GetView<AddPropertyController> {
          ...
          TypeAheadFormField(
            ...
            itemBuilder: (context, Result suggestion) {
              ...
              return ListTile(
                ...
                title: Text(AppLocalizations.of(suggestion.isBlank!
                    ? 'No Location Found'
                    : suggestion.formattedAddress!)),
                subtitle: Text(AppLocalizations.of(
                    suggestion.isBlank! ? '' : '${suggestion.name}')),
              );
            },
    ...
    return Obx(() => Scaffold(
        ...
        bottomNavigationBar: Container(
            ...
            child: controller.selectedMarker.value.visible
                ? _customButton(AppLocalizations.of('Confirm'), Colors.red,
                    () async {
                    Navigator.of(context).pop();
                    controller.mapcontroller == null;
