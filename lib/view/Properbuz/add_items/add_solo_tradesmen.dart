...
class SoloTradesmenView extends StatefulWidget {
  String companyType;
  String companyId;
  List preFillData;

  SoloTradesmenView(this.companyType, this.companyId, this.preFillData,
      {Key? key})
      : super(key: key);

  @override
  State<SoloTradesmenView> createState() => _SoloTradesmenViewState();
}

class _SoloTradesmenViewState extends State<SoloTradesmenView> {
  @override
  void initState() {
  ...
  Widget _customWorkList(List<String> list) {
    return Container(
      // height: 200,
          ...
          child: Container(
              ...
              child: Column(
                children: [
                  ...
                  workArea.length > 0 ? _customWorkList(workArea) : Container(),
                  Align(
                    alignment: Alignment.centerLeft,
                    child: _headerCard(AppLocalizations.of("Work") +
                        " " +
