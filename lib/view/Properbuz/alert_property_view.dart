...
class AlertPropertyView extends StatefulWidget {
  final int? index;
  final int? val;

  const AlertPropertyView({Key? key, this.index, this.val}) : super(key: key);

  @override
  State<AlertPropertyView> createState() => _AlertPropertyViewState();
}

class _AlertPropertyViewState extends State<AlertPropertyView> {
      ...
      appBar: AppBar(
        ...
        actions: [
          _iconButton(Icons.share, 25, () {
            Share.share(
                "Check out this property on Properbuz \n ${controller.savedProperties[widget.index!].shareurl}",
          ...
          // Obx(
          //     () => _iconButton(CupertinoIcons.heart_fill, 25, () {
