...
class PopularPropertyAdviserCard
    extends GetView<PopularRealEstateMarketController> {
  final int index;
  final int? val;
  const PopularPropertyAdviserCard({
    Key? key,
    required this.index,
    this.val,
  }) : super(key: key);
    ...
    return FittedBox(
      ...
      child: TextButton.icon(
        style: ButtonStyle(
            ...
            backgroundColor: controller.lstofpopularrealestatemodel[index]
                            .followStatus!.value ==
                        1 ||
                    controller.lstofpopularrealestatemodel[index].followStatus!
                            .value ==
                        4
        ...
        onPressed: () {
          controller.followTheAgent(
              controller.lstofpopularrealestatemodel[index].agentId!, index);
        },
        icon: (controller.lstofpopularrealestatemodel[index].followStatus!
                        .value ==
                    1 ||
                controller.lstofpopularrealestatemodel[index].followStatus!
                        .value ==
    ...
    return Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Obx(() => controller.lstofpopularrealestatemodel[index].agentId !=
      ...
      child: Column(
        children: [
          ...
          _customInfoCard(
            ...
            AppLocalizations.of(
                controller.lstofpopularrealestatemodel[index].memberFirstname ==
                        null
                    ? AppLocalizations.of("Not") +
                        " " +
                        AppLocalizations.of("found")
                    : controller
                        .lstofpopularrealestatemodel[index].memberFirstname!),
          ),
          _divider(),
          _customInfoCard(
