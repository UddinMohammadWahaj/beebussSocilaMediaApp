...
class LocationSearchPageMap extends GetView<SearchByMapController> {
  const LocationSearchPageMap({
    Key? key,
  }) : super(key: key);
    ...
    return ListTile(
      ...
      onTap: () {
        controller.setLocation(
            ...
            controller.locations[index]['lat'],
            controller.locations[index]['long'],
            context);
      },
      leading: Icon(
          ...
          child: controller.isLocationLoading.value
              ...
              : Container(
                  child: controller.locations.length == 0 &&
                          controller.searchLocation.text.isNotEmpty
                      ? _noLocationCard()
                      : ListView.builder(
