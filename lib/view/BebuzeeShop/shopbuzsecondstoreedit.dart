...
class BebuzeeMerchantInnerViewSecondStoreEdit extends StatefulWidget {
  BebuzeeShopMerchantController? controller;

  BebuzeeMerchantInnerViewSecondStoreEdit({Key? key, this.controller})
      : super(key: key);

  @override
  State<BebuzeeMerchantInnerViewSecondStoreEdit> createState() =>
      _BebuzeeMerchantInnerViewSecondStoreEditState();
}

class _BebuzeeMerchantInnerViewSecondStoreEditState
    extends State<BebuzeeMerchantInnerViewSecondStoreEdit> {
  @override
              ...
              child: Container(
                ...
                child: PageView.builder(
                  ...
                  itemBuilder: (context, index) => Obx(() =>
                      ...
                      widget.controller!.storeEditPhotos.length == 0
                          ? GestureDetector(
                              onTap: () {
                                widget.controller!.pickPhotosFilesStore();
                              },
                              child: Card(
                                child: Container(
                                  height: 30.0.h,
                          ...
                          : Stack(alignment: Alignment.topRight, children: [
                              ...
                              IconButton(
                                onPressed: () {
                                  ...
                                  widget.controller!.storeEditPhotos.clear();
                                  widget.controller!.storeEditPhotos.refresh();
                                },
