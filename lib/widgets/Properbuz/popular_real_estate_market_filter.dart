...
class PopularFilterPropertyBottomSheet
    extends GetView<PopularRealEstateMarketController> {
  const PopularFilterPropertyBottomSheet({Key? key}) : super(key: key);
    ...
    return GestureDetector(
      ...
      onTap: () {
        ...
        controller.searchFilter(
          propertytype: controller.currrentPropertyCode.value ?? "",
          bathroomcount: controller.currentBathroom.value ?? "",
          bedroomcount: controller.currentBedroom.value ?? "",
                ...
                children: [
                  ...
                  _customListTilePrice(
                    ...
                    controller.fetchPriceListSale(() {
                      customBarBottomSheetPriceList(
                          ...
                          controller.pricelistsale.value,
                          Price.max);
                    }, Price.max);
                  ...
                  _customListTileBedroom(
                    ...
                    controller.fetchBedroomList(() {
                      customBarBottomSheetBedroomList(Get.size.height / 2,
                          'Rooms', controller.bedroomlist.value);
                    });
                  }, BorderStyle.solid),
