...
class EditSoloTradesmenView extends StatefulWidget {
  const EditSoloTradesmenView({Key? key}) : super(key: key);

  @override
  State<EditSoloTradesmenView> createState() => _EditSoloTradesmenViewState();
}

class _EditSoloTradesmenViewState extends State<EditSoloTradesmenView> {
