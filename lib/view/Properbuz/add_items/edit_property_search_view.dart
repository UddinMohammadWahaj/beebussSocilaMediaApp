...
class LocationSearchPageEdit extends GetView<EditPropertyController> {
  String? page;
  LocationSearchPageEdit({Key? key, this.page}) : super(key: key);
  ...
  Widget _locationCard(int index, BuildContext context) {
    return ListTile(
      ...
      onTap: () => controller.setLocation(controller.locations[index], context),
      leading: Icon(
