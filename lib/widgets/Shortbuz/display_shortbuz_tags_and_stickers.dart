...
class DisplayShortbuzTags extends StatelessWidget {
  final Position e;

  const DisplayShortbuzTags({Key? key, required this.e}) : super(key: key);
...
class DisplayShortbuzStickers extends StatelessWidget {
  final StickerVideo s;

  DisplayShortbuzStickers({Key? key, required this.s}) : super(key: key);
