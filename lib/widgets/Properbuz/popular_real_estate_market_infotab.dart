...
class PopularPropertyContentCard
    extends GetView<PopularRealEstateMarketController> {
  int index;
  PopularPropertyContentCard({Key? key, required this.index}) : super(key: key);
                  ...
                  Positioned(
                    ...
                    onPressed: () {
                      Navigator.of(Get.context!).push(MaterialPageRoute(
                          builder: (context) => PopularNearBy(index, 1)));
                    },
                    icon: Icon(
                      Icons.fullscreen,
                      color: Colors.black,
                ...
                children: [
                  WebView(
                    ...
                    initialUrl: controller.fetchStreetView(
                            controller.lstofpopularrealestatemodel[index].lat!,
                            controller
                                .lstofpopularrealestatemodel[index].long!) ??
                        "",
                    javascriptMode: JavascriptMode.unrestricted,
                    onPageStarted: (String url) {
                      print('Page started loading: $url');
                  ...
                  Positioned(
                    ...
                    onPressed: () {
                      Navigator.of(Get.context!).push(MaterialPageRoute(
                          builder: (context) => PopularNearBy(index, 2)));
                    },
                    icon: Icon(
                      Icons.fullscreen,
                      color: Colors.black,
