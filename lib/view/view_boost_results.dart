...
class BoostResults extends StatefulWidget {
  ...
  @override
  _BoostResultsState createState() => _BoostResultsState();
}

class _BoostResultsState extends State<BoostResults> {
  ...
  int? totalMaleFrom1317;
  int? totalMaleFrom1824;
  int? totalMaleFrom2534;
  int? totalMaleFrom3544;
  int? totalMaleFrom4554;
  int? totalMaleFrom5564;
  int? totalMaleFrom65;
  int? totalFemaleFrom1317;
  int? totalFemaleFrom1824;
  int? totalFemaleFrom2534;
  int? totalFemaleFrom3544;
  int? totalFemaleFrom4554;
  int? totalFemaleFrom5564;
  int? totalFemaleFrom65;

  double? newsFeedPercentage;
  double? blogbuzPercentage;
  double? hashtagPercentage;
  double? relatedBlogPercentage;
  double? postDetailsPercentage;
  double? peopleImagesPercentage;
  ...
  Future<void> getResults() async {
    var url =
        "https://www.bebuzee.com/api/boost_post_home_edit.php?action=boost_post_home_edit&user_id=${widget.memberID}&post_type=${widget.postType}&country=${widget.country}&post_id=${widget.postID}&boost_id=${widget.boostID}";
    print("url of view results=$url");
    ...
    if (response.statusCode == 200) {
      setState(() {
        ...
        spentAmount = response.data['data']['spent_amount'];
        clicks = response.data['data']['total_links_click'];
        intClicks = response.data['data']['link_clicks_int'];
        reach = response.data['data']['total_reach'];
        perClickCost = response.data['data']['cost_per_link'];
        days = response.data['data']['days'];
        status = response.data['data']['status_edit'];
        objective = response.data['data']['objective'];
        totalBudget = response.data['data']['budget'];
        duration = response.data['data']['duration'];
        endDate = response.data['data']['end_date'];
        creationDate = response.data['data']['created'];
        createdBy = response.data['data']['user_name'];
        availableBalance = response.data['data']['wallet_balance'];
        locationsBoosted = response.data['data']['chart_location_fn_val'];
        audienceName = response.data['data']['audience_name'];
        age = response.data['data']['age'];

        totalMaleFrom1317 = response.data['data']['total_male_from13_17'];
        totalMaleFrom1824 = response.data['data']['total_male_from18_24'];
        totalMaleFrom2534 = response.data['data']['total_male_from25_34'];
        totalMaleFrom3544 = response.data['data']['total_male_from35_44'];
        totalMaleFrom4554 = response.data['data']['total_male_from45_54'];
        totalMaleFrom5564 = response.data['data']['total_male_from55_64'];
        totalMaleFrom65 = response.data['data']['total_male_from65'];

        totalFemaleFrom1317 = response.data['data']['total_female_from13_17'];
        totalFemaleFrom1824 = response.data['data']['total_female_from18_24'];
        totalFemaleFrom2534 = response.data['data']['total_female_from25_34'];
        totalFemaleFrom3544 = response.data['data']['total_female_from35_44'];
        totalFemaleFrom4554 = response.data['data']['total_female_from45_54'];
        totalFemaleFrom5564 = response.data['data']['total_female_from55_64'];
        totalFemaleFrom65 = response.data['data']['total_female_from65'];

        newsFeedPercentage = response.data['data']['news_feed_percentage'];
        peopleImagesPercentage =
            response.data['data']['people_images_percentage'];
        hashtagPercentage = response.data['data']['hashtag_percentage'];
        postDetailsPercentage =
            response.data['data']['post_details_percentage'];

        print(totalFemaleFrom65);
        print(totalMaleFrom1824);
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () {
                              print("the post id=${widget.postID}");
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => EditBoost(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Reach(
                              ...
                              clickValue: perClickCost.toString(),
                            ),
                          ],
                        ),
                      ),
                      ...
                      Padding(
                        ...
                        child: RichText(
                            text: TextSpan(
                                ...
                                children: <TextSpan>[
                              TextSpan(
                                text: AppLocalizations.of("This ad reached") +
                                    " ",
                              ),
                              TextSpan(
                                  text: reach.toString(), style: blackBold),
                              TextSpan(
                                  text: " " +
                                      AppLocalizations.of(
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              mainAxisAlignment: MainAxisAlignment.spaceBetween,
                              children: [
                                Text("Audience Name", style: blackBoldShaded),
                                Text(audienceName ?? "")
                              ],
                            ),
                            Divider(
