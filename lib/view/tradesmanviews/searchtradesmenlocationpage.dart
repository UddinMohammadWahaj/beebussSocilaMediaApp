...
class NewSearchAddTradesmenLocationSearchPage
    extends GetView<EditTradesmenController> {
  String countryName;
  String TextFiledData;
  NewSearchAddTradesmenLocationSearchPage(this.countryName, this.TextFiledData,
      {Key? key})
      : super(key: key);
        ...
        appBar: AppBar(
          ...
          leading: IconButton(
            ...
            onPressed: () {
              ...
              // controller.locationtext.value = null;
            },
          ),
          title: Text(
