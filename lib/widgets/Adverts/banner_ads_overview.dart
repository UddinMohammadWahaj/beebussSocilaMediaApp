...
class BannerAdsOverview extends StatefulWidget {
  final List<String>? bannerImages;

  final String? dataID;

  BannerAdsOverview({Key? key, this.dataID, this.bannerImages})
      : super(key: key);

  @override
  _BannerAdsOverviewState createState() => _BannerAdsOverviewState();
}

class _BannerAdsOverviewState extends State<BannerAdsOverview> {
  ...
  Future<void> getResults() async {
    ...
    print("get result banner url=$url");
                          ...
                          GestureDetector(
                            onTap: () {
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => EditBannerAd(
                                            bannerImages: widget.bannerImages!,
