...
class NewMessageScreen extends GetView<ProperbuzFeedController> {
  final int? index;
  final int? val;
  final postId;

  const NewMessageScreen({Key? key, this.index, this.val, this.postId})
      : super(key: key);
    ...
    return ListTile(
      ...
      leading: CircleAvatar(
        ...
        backgroundImage: CachedNetworkImageProvider(
            controller.directUsersList[index].image!),
      ),
      title: Text(
