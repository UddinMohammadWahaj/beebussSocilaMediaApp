...
class PopularPropertyFeaturesView
  ...
  const PopularPropertyFeaturesView(
  ...
  Widget _featureItem() {
    switch (feature) {
      case 2:
        return PopularFloorPlanItemFeature(
          index: index!,
        );
        break;
      case 3:
        return PopularVirtualTourFeature(
          index: index!,
          val: val!,
        );
        break;
      case 4:
        return controller.lstofpopularrealestatemodel[index!].video != "" &&
                controller.lstofpopularrealestatemodel[index!].video != null
            ? WebView(
                initialUrl:
                    controller.lstofpopularrealestatemodel[index!].video ?? "",
        ...
        break;
      case 5:
        return PopularMapFeatureItem(
          index: index!,
          val: val!,
        );
        break;
      default:
        return PopularPhotosItemFeature(
          index: index!,
          val: val!,
        );
        break;
