...
import 'package:bizbultest/widgets/Properbuz/property/searchbymapfeatures/searchbymapdetailedinforow.dart';
import 'package:bizbultest/widgets/Properbuz/property/searchbymapfeatures/searchbymapinfocard.dart';
import 'package:bizbultest/widgets/Properbuz/property/searchbymapfeatures/searchbymappropertyadvisercard.dart';
import 'package:bizbultest/widgets/Properbuz/property/searchbymapfeatures/searchbymappropertycontentcard.dart';
import 'package:bizbultest/widgets/Properbuz/property/searchbymapfeatures/searchbymappropertyimagespageview.dart';
...
class SearchByMapDetail extends GetView<SearchByMapController> {
  final index;
  SearchByMapDetail(this.index);
  ...
  Widget _reviewDescription() {
    return Container(
        padding: EdgeInsets.only(top: 3),
        child: Html(
          data: controller.propertylist[index]!.propertyDescription,
    ...
    return Positioned.fill(
      ...
      child: Align(
        ...
        child: Container(
            ...
            child: Obx(() => Text(
                  "${controller.propertylist[index]!.images!.length} photos",
                  style: TextStyle(
            ...
            children: [
                ...
                child: Stack(
                  children: [
                    PageView.builder(
                        ...
                        itemCount:
                            controller.propertylist[index]!.images!.length,
              ...
              Expanded(
                child: ListTile(
                  ...
                  subtitle: Text(
                    // '${controller.propertylist[index]!.shareUrl.substring(0, (controller.propertylist[index]!.shareUrl.length / 2).toInt())}',
              ...
              ? Container(
                  ...
                  children: [
                    _contactButton(
                      ...
                      print(
                          'contact num= ${controller.propertylist[index]!.memberContactNo}');
                    ...
                    _contactButton(
                      ...
                      print(
                          'contact num= ${controller.propertylist[index]!.memberEmail}');
                      controller.emailAgent(
                          '${controller.propertylist[index]!.memberEmail}');
                    }, 0),
                  ],
                ))
              : Container(),
  ...
  Future showSnack(String errorMsg, int resp) async {
    // await Get.showSnackbar(await Get.showSnackbar(GetBar(
  ...
  Future shareWidget() async {
    print("shareurl =${controller.propertylist[index]!.shareUrl}");
    await showDialog(
      context: Get.context!,
        ...
        actions: [
          ...
          TextButton(
            ...
            onPressed: () async {
              FlutterShare.share(
                  title: 'Property ',
                  linkUrl: controller.propertylist[index]!.shareUrl);
              Navigator.of(context).pop();
            },
          ...
          Obx(
            () => TextButton.icon(
                ...
                onPressed: () async {
                  ...
                  print(
                      "here the id =${controller.propertylist[index]!.propertyId}");
                  controller.shareProp(
                      controller.propertylist[index]!.propertyId!,
                      controller.propertylist[index]!.shareUrl!, (resp) {
          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                Obx(() => (controller.propertylist[index]!.images!.length != 0)
                    ? _listOfimageCard()
                    : Container()),
              ],
            ),
  ...
  Widget _iconButton2(
    ...
    return Container(
      ...
      decoration: controller.propertylist[index]!.savedStatus!.value
          ? BoxDecoration(
              shape: BoxShape.circle,
              color: Colors.white,
            )
                ...
                child: Column(
                  children: [
                    ...
                    (controller.propertylist[index]!.images!.length == 0)
                        ? _imageCard()
                        : SearchByMapPropertyImagesPageView(
                            index: index,
                          ),
                    // DetailedInfoRow(
                    //   index: this.index,
                    //   val: this.index,
                    // ),
                    SearchByMapDetailedInfoRow(
                      index: this.index,
                      val: this.index,
                    ),

                    SearchByMapPropertyInfoCard(
                      index: this.index,
                      val: this.index,
                      padding: 15,
                    ),
                    ...
                    FutureBuilder(
                      ...
                      builder: (context, snapshot) {
                        if (snapshot.data != null)
                          return SearchByMapPropertyContentCard(
                            index: index,
                          );
                        else
                          return Container();
                    ...
                    SearchByMapPropertyAdviserCard(
                      index: index,
                    )
                  ],
                ),
