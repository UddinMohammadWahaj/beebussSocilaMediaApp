...
class NewFindTradsmenView extends StatefulWidget {
  const NewFindTradsmenView({Key? key}) : super(key: key);

  @override
  State<NewFindTradsmenView> createState() => _NewFindTradsmenViewState();
}

class _NewFindTradsmenViewState extends State<NewFindTradsmenView> {
  @override
  void initState() {
    super.initState();
