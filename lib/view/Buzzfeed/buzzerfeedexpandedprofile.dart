  ...
  final parse = <MatchText>[
    ...
    MatchText(
      ...
      onTap: (String tag) {
        ...
        print('-----Text=${newText.substring(1)}');
      },
    ),
  ];
...
class BuzzerfeedExpandedProfile extends StatefulWidget {
  var description;
  String? avatar;
  String? username;
  String? name;
  ...
  @override
  State<BuzzerfeedExpandedProfile> createState() =>
      _BuzzerfeedExpandedProfileState();
}

class _BuzzerfeedExpandedProfileState extends State<BuzzerfeedExpandedProfile> {
  var postusername = "${CurrentUser().currentUser.fullName}";
  late BuzzerfeedExpandedProfileController controller;

  @override
  void initState() {
    controller = Get.put(BuzzerfeedExpandedProfileController(
        buzzerfeedId: widget.buzzerfeedMainController!
            .listbuzzerfeeddata[widget.userindex!].buzzerfeedId));
    print(
        "============== ${widget.buzzerfeedMainController!.listbuzzerfeeddata[widget.userindex!].buzzerfeedId}");
  ...
  Widget build(BuildContext context) {
    ...
    Widget expandedBody() {
      var newText = widget.description.replaceAll("\$", "~~");
      return Container(
          margin: EdgeInsets.only(left: 2.0.w),
      ...
      return Container(
        ...
        decoration: BoxDecoration(
          color: widget.buzzerfeedMainController!
                  .listbuzzerfeeddata![widget.userindex!]!.isvoting!.value
    ...
    Widget testpollBody() {
      var totalpoll = widget.buzzerfeedMainController!
          .listbuzzerfeeddata[widget.userindex!].testpoll!.length;
          ...
          itemBuilder: (context, index) {
            ...
            return Obx(
              () => InkWell(
                  ...
                  child: pollcontainer(
                    '${widget.buzzerfeedMainController!.listbuzzerfeeddata[widget.userindex!].pollAnswer![index].answer}',
                    widget
                        .buzzerfeedMainController!
                        .listbuzzerfeeddata[widget.userindex!]
                        .testpoll!
                      ...
                      onPressed: () {
                        Navigator.of(Get.context!).push(MaterialPageRoute(
                          builder: (context) => BuzzfeedUploadPost(
                            ...
                            from: 'expanded',
                            // BuzzerfeedExpandedProfileController: controller,
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
            onPressed: () {
              Get.delete<BuzzerfeedExpandedProfileController>();
              Navigator.of(context).pop();
            },
            icon: Icon(
              Icons.arrow_back,
                  ...
                  (widget
                      ...
                      ? ReTweet(
                          ...
                          quotes: widget.buzzerfeedMainController!
                              .listbuzzerfeeddata![widget.userindex!].quotes!,
