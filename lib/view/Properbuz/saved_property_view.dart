...
class SavedPropertyView extends StatefulWidget {
  final int? index;
  final int? val;

  const SavedPropertyView({Key? key, this.index, this.val}) : super(key: key);

  @override
  State<SavedPropertyView> createState() => _SavedPropertyViewState();
}

class _SavedPropertyViewState extends State<SavedPropertyView> {
                ...
                child: Column(
                  children: [
                    ...
                    widget.val! == 2
                        ...
                        : PropertyContentCard(index: 0, val: 0),
