...
import 'package:bizbultest/widgets/shortbuz_player_discover.dart';
...
class ShortBuzVideoCardDiscover extends StatefulWidget {
  final Data video;

  ShortBuzVideoCardDiscover({Key? key, required this.video}) : super(key: key);

  @override
  _ShortBuzVideoCardDiscoverState createState() =>
      _ShortBuzVideoCardDiscoverState();
}

class _ShortBuzVideoCardDiscoverState extends State<ShortBuzVideoCardDiscover>
        ...
        children: [
          ...
          Positioned.fill(
            ...
            child: Align(
                ...
                child: GestureDetector(
                  onTap: () {
                    Share.share(widget.video.postUrlToShare!);
                  },
                  child: Column(
                    children: [
                      Icon(
